        ...
        <div className="flex items-center justify-between border-b border-zinc-200 pb-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="submit"
              form="settings"
              className="rounded-lg bg-violet-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition delay-150 duration-300 ease-in-out hover:bg-violet-700"
            >
              Save
            </button>
          </div>
        ...
        >
          <div className="grid-cols-form grid gap-3">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <Input.InputRoot>
                <Input.InputControl defaultValue="Souza" />
              </Input.InputRoot>
            </div>
          </div>
          ...
          <div className="grid-cols-form grid gap-3 pt-5">
            ...
            <Input.InputRoot>
              ...
              <Input.InputControl
                id="email"
                type="email"
                defaultValue="marcos.souza@atomlabs.com.br"
              />
            </Input.InputRoot>
          </div>
          ...
          <div className="grid-cols-form grid gap-3 pt-5">
            ...
            <div className="flex items-start gap-5">
              ...
              >
                <div className="border-6 rounded-full border-zinc-50 bg-zinc-100 p-2 group-hover:border-red-50 group-hover:bg-violet-100">
